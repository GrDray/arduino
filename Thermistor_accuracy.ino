...
void Thermistor(int16_t ADCvalue)
{
  ...
  double lnR;
  double V = ReadVoltage(A0); // ADC accuracy improved for ESP32
  int16_t R = 9990 * V / (5 - V); //Thermistor resistence:assuming 9990 is the measured resistance of 10K resistor by a multi-meter.
